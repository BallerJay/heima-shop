...
export default {
  ...
  data() {
    return {
      ...
      // 如果在data当中定义inputVisible和inputValue，会出现bug，当前展开行的数据和其他行的数据一样
      // // 控制按钮与文本框的切换显示
      // inputVisible: false,
      // // 文本框中输入的内容
      // inputValue: '',
  ...
  methods: {
    ...
    async getParamsData() {
      ...
      // 此处证明算中的是三级分类  根据所分类的id 和当前所处的面板，获取对应的参数
      ...
      res.data.forEach((item) => {
        // 当item.attr_vals为空时，返回一个空数组,否则会出现一个空tag
